            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/register">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 label text-md-right">{{ __('Senha') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 label text-md-right">{{ __('Confirmar Senha') }}</label>
